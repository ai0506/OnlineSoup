-- Fix open_puzzle: add explicit owner_seat check, make system message insert
-- conditional to avoid NOT NULL constraint failure when seat data is unexpected.
-- Also reload schema cache to fix PGRST202 "function not in schema cache" errors.
